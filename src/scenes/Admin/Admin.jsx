...
export const Admin = () => {
    ...
    const fruitFreqRef = useRef(undefined);
    const maxConnRef = useRef(undefined);
    ...
    function startFruitGame() {
        const element = fruitFreqRef.current;
        if (!element) return
    ...
    function setMaxConcurrentConnections() {
        const element = maxConnRef.current;
        if (!element) return
